      ...
      <div className="flex border-b border-[#E2E8F0] overflow-x-auto">
        {tabs.map(tab => (
          <button
            ...
            className={`px-5 py-4 text-sm font-semibold transition-colors border-b-2 -mb-px whitespace-nowrap flex-shrink-0 ${active === tab.id ? 'border-[#C9A84C] text-[#0A1628]' : 'border-transparent text-[#718096] hover:text-[#0A1628]'
              }`}
          >
            {tab.label}
          </button>
